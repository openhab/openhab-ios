...
- (void)displayWidget
{
    ...
    if (widget.image == nil) {
      [self.widgetImage sd_setImageWithURL:[NSURL URLWithString:chartUrl] placeholderImage:nil options:SDWebImageCacheMemoryOnly completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
