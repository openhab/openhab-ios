...
enum SitemapDiagnostics {
    ...
    static func logWidgetVersions(changedRowCount: Int, changedRowKinds: String) {
        guard isEnabled else { return }
        logger.info("widgetVersions changedRows=\(changedRowCount, privacy: .public) changedKinds=\(changedRowKinds, privacy: .public)")
    }
