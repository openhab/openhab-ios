...
class OpenHABNotificationsViewControllerTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        refreshControl?.addTarget(self, action: #selector(OpenHABNotificationsViewControllerTableViewController.handleRefresh(_:)), for: .valueChanged)
        ...
        let rightDrawerButton = MMDrawerBarButtonItem(target: self, action: #selector(OpenHABNotificationsViewControllerTableViewController.rightDrawerButtonPress(_:)))
    ...
    func loadNotifications() {
        ...
        var notificationsUrlString: String? = nil
        ...
        var notificationsRequest: NSMutableURLRequest? = nil
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: OpenHABNotificationsViewControllerTableViewController.tableViewCellIdentifier) as? NotificationTableViewCell
