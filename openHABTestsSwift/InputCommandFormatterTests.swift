...
struct InputCommandFormatterTests {
    ...
    func singleDigitIsValid() {
        #expect(InputCommandFormatter.isValidNumberDraft("5", decimalSeparator: "."))
    }

    @Test
    func multipleDigitsAreValid() {
        #expect(InputCommandFormatter.isValidNumberDraft("123", decimalSeparator: "."))
    }
    ...
    func negativeNumberIsValid() {
        #expect(InputCommandFormatter.isValidNumberDraft("-42", decimalSeparator: "."))
    }

    @Test
    func decimalNumberIsValid() {
        #expect(InputCommandFormatter.isValidNumberDraft("3.14", decimalSeparator: "."))
    }

    @Test
    func trailingDecimalIsValid() {
        #expect(InputCommandFormatter.isValidNumberDraft("3.", decimalSeparator: "."))
    }
    ...
    func multipleDecimalSeparatorsRejected() {
        #expect(!InputCommandFormatter.isValidNumberDraft("3.1.4", decimalSeparator: "."))
    }
    ...
    func negativeSignInMiddleRejected() {
        #expect(!InputCommandFormatter.isValidNumberDraft("3-5", decimalSeparator: "."))
    }

    @Test
    func lettersRejected() {
        #expect(!InputCommandFormatter.isValidNumberDraft("12a3", decimalSeparator: "."))
    }

    @Test
    func spacesRejected() {
        #expect(!InputCommandFormatter.isValidNumberDraft("1 2", decimalSeparator: "."))
    }
    ...
    func nonNumberHintPassesThrough() {
        let result = InputCommandFormatter.filteredDraftInput(from: "abc!@#", previousText: "", hint: nil)
        #expect(result == "abc!@#")
    }

    @Test
    func numberHintAcceptsValidDraft() {
        let result = InputCommandFormatter.filteredDraftInput(from: "123", previousText: "", hint: .number)
        #expect(result == "123")
    }

    @Test
    func numberHintRejectsInvalidDraft() {
        let result = InputCommandFormatter.filteredDraftInput(from: "12a3", previousText: "12", hint: .number)
        #expect(result == "12")
    }

    @Test
    func numberHintAcceptsNegativeSign() {
        let result = InputCommandFormatter.filteredDraftInput(from: "-", previousText: "", hint: .number)
        #expect(result == "-")
    }
    ...
    @Test
    func commandFromEmptyStringReturnsNil() {
    ...
    func commandFromNonNumberHintReturnsTrimmed() {
        #expect(InputCommandFormatter.command(from: "  hello  ", hint: nil) == "hello")
    }
    ...
    func oracleTypingSequences(sep: String) {
        ...
        for sequence in sequences {
            ...
            for char in sequence {
                ...
                let draftValid = InputCommandFormatter.isValidNumberDraft(hypotheticalResult, decimalSeparator: sep)
    ...
    func oracleRejectsSecondDecimalSeparator(sep: String) {
        ...
        #expect(
            !InputCommandFormatter.isValidNumberDraft(wouldBeResult, decimalSeparator: sep),
    ...
    func oracleRejectsPlusSign(sep: String) {
        ...
        #expect(!InputCommandFormatter.isValidNumberDraft("+", decimalSeparator: sep))
    }
    ...
    func oracleAcceptsDeletionFromEnd(sep: String) {
        ...
        #expect(InputCommandFormatter.isValidNumberDraft(result, decimalSeparator: sep))
    }
        ...
        for oldString in validStarts {
            for pos in 0 ... oldString.count {
                for char in testChars {
                    ...
                    let draftValid = InputCommandFormatter.isValidNumberDraft(resultString, decimalSeparator: sep)
